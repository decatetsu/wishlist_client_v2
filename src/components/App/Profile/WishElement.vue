...
<template>
  <div class="wish-card relative bg-gray-200 dark:bg-gray-700/50 rounded-md text-gray-950 dark:text-gray-200 shadow-md">
    ...
    <button class="edit-button xl:invisible xl:opacity-0 p-2 bg-gray-700 border-gray-400 absolute right-0 rounded-es-md rounded-se-md transition ease-linear duration-200">
